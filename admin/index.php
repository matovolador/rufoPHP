...
<html>
  <head>
    ...
    <title>RufoPHP - Admin Panel</title>
    <!-- Latest compiled and minified CSS -->
		<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">

		<link rel="stylesheet" href="<?php echo SITE_URL ?>admin/css/bootstrap-theme.min.css">
  ...
  <body>
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			      ...
			      <?php
			    	if (isset($_SESSION['admin'])){ ?>
				      <li><a href="<?php echo SITE_URL ?>actions/admin/logout.php"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> Sign Out</a></li>

				    <?php
			    	}else{  ?>
			    		<li><a href="<?php echo SITE_URL ?>admin/login"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Sign In</a></li>
			    	<?php } ?>
    ...
    <footer>
		...
		function signout() {
	      	$.ajax({
	           type: "POST",
	           url: SITE_URL+'actions/admin/logout.php',
	           data:{action:'logout'},
